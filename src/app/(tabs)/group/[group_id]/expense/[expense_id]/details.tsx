      ...
      <CollapsableHeader
        ...
        content={
          <View className="flex-1 p-5">
            ...
            {!expense?.settled && (
              <Link
                href={`/(tabs)/group/${group_id}/expense/${id}/update`}
                asChild
              >
                <Pressable>
                  <Text className="mt-2 w-full border-blue-500 text-blue-500 border-[1px] rounded-[20px] p-2 text-center text-xl">
                    Edit expense
                  </Text>
                </Pressable>
              </Link>
            ...
            {expense?.settled ? (
              <Text className="mt-4 w-full text-center text-green-600 text-4xl">
                Settled
              </Text>
            ) : (
              <TouchableOpacity onPress={() => setIsDialog2Visible(true)}>
                <Text className="mt-2 w-full border-green-500 text-green-500 border-[1px] rounded-[20px] p-2 text-center text-xl">
                  Mark as settled
                </Text>
              </TouchableOpacity>
            )}
                ...
                {!expense?.settled && (
                  <Menu.Item
                    onPress={() => {
                      ...
                      router.push({
                        pathname:
                          "/(tabs)/group/[group_id]/expense/[expense_id]/update",
                        params: { group_id: group_id, expense_id: id },
                      });
                    }}
                    title="Edit expense"
                  />
