      ...
      <Pressable className="bg-white my-1 py-3 px-3 rounded-lg">
        <View className="flex-row justify-between px-5 mb-5">
          ...
          <TouchableOpacity onPress={handleAnchor}>
            <Feather size={28} name={'anchor'} color={anchored ? 'black' : '#aaa'}/>
          </TouchableOpacity>
        </View>
        ...
        <View className={'flex-row justify-between mx-5'}>
          <View className={'flex-row'}>
            ...
            <Text className={'text-[#aaa]'}>{group.expense_count} Expenses</Text>
          </View>
          {group.settled ? <Text className={'text-green-500'}>Settled</Text>
