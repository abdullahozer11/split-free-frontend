...
## Project Overview
SplitFree is a collaborative, real-time bill-splitting mobile application built to simplify expense sharing and group balance calculations. The application is built on **Expo (React Native)** with TypeScript, styled with **NativeWind (Tailwind CSS)**, and backed by a local/remote **Supabase** instance orchestrating user authentication, real-time database subscriptions, and PostgreSQL database migrations.
