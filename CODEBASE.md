...
├── tsconfig.typecheck.json        # CI typecheck of API, lib, providers, translations, wrappers, helpers, shared components, auth/account, friends, join, group list/details/stats/update, expenses, transfers, members
...
│   │   ├── invites/               # QR/link invite mint (`generate_invite_token` RPC)
