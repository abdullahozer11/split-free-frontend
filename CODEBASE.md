...
├── tsconfig.typecheck.json        # CI typecheck of API, lib, providers, translations, wrappers, helpers, shared components, auth/account, friends, join, group list
